...
const AuctionPage = () => {
  ...
  const allProducts = () => {
    ...
    axios({
      ...
      url: `${process.env.REACT_APP_BASEURL}auction/auction_page/${id}`,
    })
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Start Bid : ₹ {ProductData.bid_start_amount} /-
              </Typography>
              <Typography
                sx={{
                  fontSize: "16px",
                ...
                onClick={() => {
                  if (getCookie("account")) {
                    ...
                    setState({
                      open1: true,
                      message:
                        "Sorry, you must be logged in to place a Wishlist.",
                    });
                  }
                }}
              >
                <BsBasketFill size="25" />
                <Typography sx={{ ml: 2, mr: 2 }}>add to WishList</Typography>
              </Button>
            </Box>
          </Box>
        </Box>
